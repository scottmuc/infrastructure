...
Rather than orchestraing a bunch of git clones, it's just simpler to check this
into my repo. It's not like this changes so frequently that I need an easy way
to stay up to date.

```
commit 0520b1f8f3eb25678444c0817a97636b6601ac85
Author: John Lewis <github@jlewis.sh>
Date:   Mon Apr 21 12:21:02 2025 +0200
